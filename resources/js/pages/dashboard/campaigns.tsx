...
const selectTriggerClass =
    'h-11 w-full data-[size=default]:h-11 rounded-full border-border bg-background px-5 text-sm shadow-none focus-visible:border-primary focus-visible:ring-0';
        ...
        <form onSubmit={submit} className="space-y-4">
            <div className="grid gap-2">
                ...
                <Input
                    ...
                    placeholder="Spring FHA – Baton Rouge"
                    required
                />
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) =>
                            form.setData('platform', value as Platform)
                        }
                    >
                        <SelectTrigger
                            id="platform"
                ...
                <div className="grid gap-2">
                    ...
                    >
                        <SelectTrigger
                            id="status"
                            className={cn(selectTriggerClass, 'capitalize')}
                        >
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent className={selectContentClass}>
            ...
            <div className="grid gap-2">
                ...
                <div className="relative">
                    <span className="pointer-events-none absolute top-1/2 left-5 -translate-y-1/2 text-sm text-foreground/50">
                        $
                    </span>
                    <Input
                        id="budget"
            ...
            <div className="grid gap-2">
                ...
                <p className="text-xs text-foreground/50">
                    Goes in the ad link as utm_campaign. Lowercase letters,
                    numbers, - and _.
                </p>
            ...
            <button
                ...
                className="inline-flex h-11 w-full items-center justify-center rounded-full bg-foreground text-sm font-semibold text-background transition-opacity hover:opacity-90 disabled:opacity-50"
            >
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <div className="flex shrink-0 gap-1">
                                        <button
                                            ...
                                            className="grid size-9 place-items-center rounded-full text-foreground/50 transition-colors hover:bg-foreground/5 hover:text-foreground"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="grid size-9 place-items-center rounded-full text-foreground/50 transition-colors hover:bg-red-500/10 hover:text-red-500"
                                        >
                                ...
                                <dl className="grid grid-cols-4 gap-2">
                                    {[
                                        ...
                                        [
                                            'Leads',
                                            number.format(campaign.leads_count),
                                        ],
                                        [
                                            'Clicks',
                                            number.format(
                                        ...
                                        >
                                            ...
                                            <dt className="text-[11px] text-foreground/50">
                                                {label}
                                            </dt>
                                        </div>
                                    ))}
            ...
            >
                <DialogContent className="max-h-[90vh] overflow-y-auto rounded-4xl sm:max-w-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Each campaign gets its own tracking link to use in
                            the ad.
                        </DialogDescription>
                    </DialogHeader>
                    {editing !== null && (
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            and its tracking link will be removed. The visits,
                            clicks and leads it already brought in are kept,
                            just no longer tied to a campaign.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
