        ...
        <v-layout>
            <v-navigation-drawer v-model="drawerNavState" temporary class="!tw-bg-white">
                <Link :href="route('welcome')" @click="drawerNavState = !drawerNavState">
                    <div class="flex items-center justify-center shadow-lg w-full p-5">
                        <img class="w-28" src="../../../public/img/primary-logo-light.jpg" alt="">
                    </div>
                </Link>

                <div class="px-5 w-full">
                    <p class="bg-orange-100 text-orange-600 border-l-8 border-l-orange-500 text-xs p-3 mt-5">
                        Don't see what you are looking for?  <span class="font-bold block">Give us a call!</span>
                    </p>
                </div>

                <div class="flex flex-col items-center gap-10 font-bold text-lg mt-5 px-5">
                    <Link :href="route('welcome')" @click="drawerNavState = !drawerNavState">
                        <div class="card_green">
                            Home
                        </div>
                    </Link>
                    <a href="https://dot.cards/shaunbrignac" target="_blank" @click="drawerNavState = !drawerNavState">
                    ...
                    <Link :href="route('programs.index')" @click="drawerNavState = !drawerNavState">
